        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 33*fem,
              child: Image.asset(
                'assets/design-system-wireframe/images/status-bar-mTx.png',
                width: 366*fem,
                height: 33*fem,
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // rectangle26GkA (7:924)
                    margin: EdgeInsets.fromLTRB(0*fem, 0.22*fem, 15.2*fem, 0*fem),
                    width: 76.8*fem,
                    height: 5.3*fem,
                    child: Image.asset(
                      'assets/design-system-wireframe/images/rectangle-26-Xpe.png',
                      width: 76.8*fem,
                      height: 5.3*fem,
                    ),
                  ),
                  Container(
                    // rectangle27bGe (7:925)
            ...
            Container(
              // placeholder17PQ (3:863)
              margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 119*fem),
              width: 301*fem,
              height: 322*fem,
              child: Image.asset(
                'assets/design-system-wireframe/images/placeholder-1-z1Y.png',
                fit: BoxFit.cover,
              ),
            ),
            Container(
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      Positioned(
                        ...
                        child: Align(
                          child: SizedBox(
                            ...
                            height: 26*fem,
                            child: Image.asset(
                              'assets/design-system-wireframe/images/vector-tdx.png',
                              width: 112*fem,
                              height: 26*fem,
                            ),
                          ),
                      ...
                      Positioned(
                        // outlineinterfacearrowrightDqk (3:873)
                        left: 89.75*fem,
                        top: 8.25*fem,
                        child: Align(
                          child: SizedBox(
                            ...
                            height: 9.5*fem,
                            child: Image.asset(
                              'assets/design-system-wireframe/images/outline-interface-arrow-right-DWi.png',
                              width: 13*fem,
                              height: 9.5*fem,
                            ),
                          ),
