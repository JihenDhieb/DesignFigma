        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 33*fem,
              child: Image.asset(
                'assets/design-system-wireframe/images/status-bar-DnS.png',
                width: 366*fem,
                height: 33*fem,
              ),
            ),
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // rectangle26rmp (7:912)
                    margin: EdgeInsets.fromLTRB(0*fem, 0.22*fem, 15.2*fem, 0*fem),
                    width: 76.8*fem,
                    height: 5.3*fem,
                    child: Image.asset(
                      'assets/design-system-wireframe/images/rectangle-26-MSJ.png',
                      width: 76.8*fem,
                      height: 5.3*fem,
                    ),
                  ),
                  Container(
                    // rectangle27yLe (7:913)
            ...
            Container(
              // placeholder1AJe (3:766)
              margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 0*fem, 122*fem),
              width: 301*fem,
              height: 322*fem,
              child: Image.asset(
                'assets/design-system-wireframe/images/placeholder-1-rRg.png',
                fit: BoxFit.cover,
              ),
            ),
            Container(
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      Positioned(
                        ...
                        child: Align(
                          child: SizedBox(
                            ...
                            height: 26*fem,
                            child: Image.asset(
                              'assets/design-system-wireframe/images/vector-Dut.png',
                              width: 112*fem,
                              height: 26*fem,
                            ),
                          ),
                      ...
                      Positioned(
                        // outlineinterfacearrowrightsMU (3:807)
                        left: 84*fem,
                        top: 1*fem,
                        child: Align(
                          child: SizedBox(
                            ...
                            height: 24*fem,
                            child: Image.asset(
                              'assets/design-system-wireframe/images/outline-interface-arrow-right-Sq8.png',
                              width: 24*fem,
                              height: 24*fem,
                            ),
                          ),
