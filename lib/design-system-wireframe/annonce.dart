              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      // autogroupczrzJyY (SaNHyZccFS2KGMpV9ScZrz)
                      width: 57.9*fem,
                      height: 27*fem,
                      child: Stack(
                        children: [
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 44.08*fem,
                  child: Image.asset(
                    'assets/design-system-wireframe/images/vector-7hk.png',
                    width: 46.03*fem,
                    height: 44.08*fem,
                  ),
                ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 67.28*fem,
                  child: Image.asset(
                    'assets/design-system-wireframe/images/vector-5NA.png',
                    width: 59.13*fem,
                    height: 67.28*fem,
                  ),
                ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 28.23*fem,
                  child: Image.asset(
                    'assets/design-system-wireframe/images/vector-zFL.png',
                    width: 31.8*fem,
                    height: 28.23*fem,
                  ),
                ),
            ...
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 51.69*fem,
                  child: Image.asset(
                    'assets/design-system-wireframe/images/vector-WqG.png',
                    width: 42.23*fem,
                    height: 51.69*fem,
                  ),
                ),
