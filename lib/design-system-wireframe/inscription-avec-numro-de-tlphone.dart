...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // inscriptionavecnumrodetlphone3 (10:999)
        width: double.infinity,
        height: 844*fem,
        ...
        child: Stack(
          children: [
            Positioned(
              ...
              child: Align(
                child: SizedBox(
                  ...
                  height: 33*fem,
                  child: Image.asset(
                    'assets/design-system-wireframe/images/status-bar-Npa.png',
                    width: 366*fem,
                    height: 33*fem,
                  ),
                ),
            ...
            Positioned(
              // inscrivezvouspourcommencerzGJ (11:1040)
              left: 23*fem,
              top: 109*fem,
              child: Align(
                child: SizedBox(
            ...
            Positioned(
              // autogroup3yiaPBx (SaLL8R9SWZPPEspwej3yia)
              left: 19*fem,
              top: 278*fem,
              child: Container(
                width: 351*fem,
                      ...
                      child: TextButton(
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                              Positioned(
                                // autogrouphss4a1Y (SaLLLpxRnw46ePg4CoHSs4)
                                ...
                                child: Align(
                                  child: SizedBox(
                                    ...
                                    height: 26*fem,
                                    child: Image.asset(
                                      'assets/design-system-wireframe/images/auto-group-hss4.png',
                                      width: 74*fem,
                                      height: 26*fem,
                                    ),
                                  ),
                              ...
                              Positioned(
                                // autogroup8clstwL (SaLLRaKWy681TvZ9pp8CLS)
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration (
                                    image: DecorationImage (
                                      fit: BoxFit.cover,
                                      image: AssetImage (
                                        'assets/design-system-wireframe/images/vector-bJz.png',
                                      ),
                                    ),
                                  ),
                                  child: Text(
                              ...
                              Positioned(
                                // outlineinterfacecaretdownVgE (11:1048)
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration (
                    image: DecorationImage (
                      fit: BoxFit.cover,
                      image: AssetImage (
                        'assets/design-system-wireframe/images/vector.png',
                      ),
                    ),
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        // outlineinterfacearrowrightRbp (11:1054)
                        margin: EdgeInsets.fromLTRB(0*fem, 1*fem, 0*fem, 0*fem),
                        width: 13*fem,
                        height: 9.5*fem,
                        child: Image.asset(
                          'assets/design-system-wireframe/images/outline-interface-arrow-right-G8i.png',
                          width: 13*fem,
                          height: 9.5*fem,
                        ),
                      ),
