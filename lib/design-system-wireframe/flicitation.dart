        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 33*fem,
              child: Image.asset(
                'assets/design-system-wireframe/images/status-bar-2i6.png',
                width: 366*fem,
                height: 33*fem,
              ),
            ),
            Container(
              // flicitations4E (14:991)
            ...
            Container(
              // motdepassemisjouravecsuccesAZ8 (14:993)
            ...
            Container(
              // placeholder14eW (14:986)
              margin: EdgeInsets.fromLTRB(39*fem, 0*fem, 0*fem, 99*fem),
              width: 301*fem,
              height: 322*fem,
              child: Image.asset(
                'assets/design-system-wireframe/images/placeholder-1-her.png',
                fit: BoxFit.cover,
              ),
            ),
            Container(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration (
                    image: DecorationImage (
                      fit: BoxFit.cover,
                      image: AssetImage (
                        'assets/design-system-wireframe/images/vector-7PY.png',
                      ),
                    ),
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        // outlineinterfacearrowright9ZU (14:1039)
                        margin: EdgeInsets.fromLTRB(0*fem, 1*fem, 0*fem, 0*fem),
                        width: 13*fem,
                        height: 9.5*fem,
                        child: Image.asset(
                          'assets/design-system-wireframe/images/outline-interface-arrow-right-Dsp.png',
                          width: 13*fem,
                          height: 9.5*fem,
                        ),
                      ),
