      ...
      child: TextButton(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                // autogroupddunpQJ (SaTAzGNvhMVcCJ1Ap9DdUn)
                    ...
                    Positioned(
                      ...
                      child: Align(
                        child: SizedBox(
                          ...
                          height: 33*fem,
                          child: Image.asset(
                            'assets/ui-mobile/images/status-bar-WPc.png',
                            width: 366*fem,
                            height: 33*fem,
                          ),
                        ),
                    ...
                    Positioned(
                      ...
                      child: Align(
                        child: SizedBox(
                          ...
                          height: 460*fem,
                          child: Image.asset(
                            'assets/ui-mobile/images/image-29-xFk.png',
                          ),
                        ),
                      ),
                    ),
                    Positioned(
                      // rectangle25qML (557:6814)
                      left: 84*fem,
                      top: 168*fem,
                      child: Align(
                        child: SizedBox(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration (
                          image: DecorationImage (
                            fit: BoxFit.cover,
                            image: AssetImage (
                              'assets/ui-mobile/images/delivery-service-orange-4-1-bg.png',
                            ),
                          ),
                        ),
                        child: Column(
                          ...
                          children: [
                            Container(
                              // h38ch38bm0014iconset00617y4 (557:6823)
                              margin: EdgeInsets.fromLTRB(154.33*fem, 0*fem, 0*fem, 28.43*fem),
                              width: 95.06*fem,
                              height: 89.8*fem,
                              child: Image.asset(
                                'assets/ui-mobile/images/h38ch38bm0014iconset006-1.png',
                                fit: BoxFit.cover,
                              ),
                            ),
                            Container(
                              // h38ch38bm0014iconset0071DWJ (557:6822)
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 139.34*fem, 0*fem),
                              width: 110.06*fem,
                              height: 103.97*fem,
                              child: Image.asset(
                                'assets/ui-mobile/images/h38ch38bm0014iconset007-1.png',
                                fit: BoxFit.cover,
                              ),
                            ),
                          ],
              ...
              Container(
                // entrervotrepositioncoL (557:6818)
              ...
              Container(
                // autogroupghdkKxe (SaTBD1Wh7Zd3yTdb4PghDk)
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      // homeindicatorv5G (I557:6819;7:2419)
