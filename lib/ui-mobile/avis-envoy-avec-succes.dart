...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // avisenvoyavecsuccescYa (496:7544)
        ...
        child: Column(
          ...
          children: [
            Container(
              // statusbarUKt (496:7545)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 43*fem),
              width: 366*fem,
              height: 33*fem,
              child: Image.asset(
                'assets/ui-mobile/images/status-bar-out.png',
                width: 366*fem,
                height: 33*fem,
              ),
            ),
            Container(
              ...
              child: TextButton(
                ...
                child: Container(
                  ...
                  height: 24*fem,
                  child: Image.asset(
                    'assets/ui-mobile/images/header-8yg.png',
                    width: 24*fem,
                    height: 24*fem,
                  ),
                ),
            ...
            Container(
              // successillustrationeNn (496:7580)
              margin: EdgeInsets.fromLTRB(2*fem, 0*fem, 0*fem, 169.84*fem),
              width: 238*fem,
              height: 224.16*fem,
              child: Image.asset(
                'assets/ui-mobile/images/success-illustration-Epr.png',
                width: 238*fem,
                height: 224.16*fem,
              ),
            ),
