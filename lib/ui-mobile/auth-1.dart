    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroupbyaafkN (SaNMXdMvJi5B9kSf5abyaa)
              width: 686*fem,
              height: 602*fem,
              child: Image.asset(
                'assets/ui-mobile/images/auto-group-byaa.png',
                width: 686*fem,
                height: 602*fem,
              ),
            ),
            Container(
              // autogroupajlnmoQ (SaNNFXKn3XXYbQvGSGajLn)
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // inscrivezvouschezventa5ZC (212:4458)
                  ...
                  Container(
                    // autogroupumr2PiJ (SaNMsx7PYgBjvV6GLLuMr2)
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                // vector3819UW (212:4495)
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1*fem),
                                width: 8*fem,
                                height: 4*fem,
                                child: Image.asset(
                                  'assets/ui-mobile/images/vector-381.png',
                                  width: 8*fem,
                                  height: 4*fem,
                                ),
                              ),
                  ...
                  Container(
                    // vousavezdjuncompteseconnectert (212:4500)
                  ...
                  Container(
                    // autogroupse4s2ka (SaNN5H7r95racdedtLse4S)
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 39.77*fem,
                          child: Image.asset(
                            'assets/ui-mobile/images/google.png',
                            width: 40*fem,
                            height: 39.77*fem,
                          ),
                        ),
                        ...
                        Container(
                          ...
                          height: 39.77*fem,
                          child: Image.asset(
                            'assets/ui-mobile/images/twitter.png',
                            width: 40*fem,
                            height: 39.77*fem,
                          ),
                        ),
                        ...
                        Container(
                          // facebookNhx (213:4631)
                          width: 40*fem,
                          height: 39.77*fem,
                          child: Image.asset(
                            'assets/ui-mobile/images/facebook.png',
                            width: 40*fem,
                            height: 39.77*fem,
                          ),
                        ),
