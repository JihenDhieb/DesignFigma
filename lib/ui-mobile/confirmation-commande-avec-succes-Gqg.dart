    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // statusbar8qY (500:6605)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 11*fem),
              width: 366*fem,
              height: 33*fem,
              child: Image.asset(
                'assets/ui-mobile/images/status-bar-jJJ.png',
                width: 366*fem,
                height: 33*fem,
              ),
            ),
            Container(
              ...
              height: 24*fem,
              child: Image.asset(
                'assets/ui-mobile/images/header-VGN.png',
                width: 24*fem,
                height: 24*fem,
              ),
            ),
            Container(
              ...
              height: 310.51*fem,
              child: Image.asset(
                'assets/ui-mobile/images/scooter.png',
                width: 351*fem,
                height: 310.51*fem,
              ),
            ),
