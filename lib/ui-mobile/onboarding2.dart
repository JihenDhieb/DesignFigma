      ...
      child: TextButton(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                // statusbarTHk (105:7451)
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 20*fem),
                width: 366*fem,
                height: 33*fem,
                child: Image.asset(
                  'assets/ui-mobile/images/status-bar-hXp.png',
                  width: 366*fem,
                  height: 33*fem,
                ),
              ),
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      // rectangle266EE (111:7875)
                      margin: EdgeInsets.fromLTRB(0*fem, 0.22*fem, 15.2*fem, 0*fem),
                      width: 76.8*fem,
                      height: 5.3*fem,
                      child: Image.asset(
                        'assets/ui-mobile/images/rectangle-26-xzE.png',
                        width: 76.8*fem,
                        height: 5.3*fem,
                      ),
                    ),
                    Container(
                      // rectangle27QVp (111:7876)
              ...
              Container(
                // commandezvotrefestinvUA (105:7453)
              ...
              Container(
                // explorezdessaveursportedemainC (105:7455)
              ...
              Container(
                // autogrouptljntZQ (SaNcqgrBuKXXBZ2FxvTLJN)
                margin: EdgeInsets.fromLTRB(2*fem, 0*fem, 0*fem, 188*fem),
                width: 399.79*fem,
                height: 261*fem,
                child: Image.asset(
                  'assets/ui-mobile/images/auto-group-tljn.png',
                  width: 399.79*fem,
                  height: 261*fem,
                ),
              ),
              Container(
                // frame8274BYW (127:196)
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      // outlineinterfacearrowright6ot (127:198)
                      margin: EdgeInsets.fromLTRB(0*fem, 1.39*fem, 0*fem, 0*fem),
                      width: 13*fem,
                      height: 13.18*fem,
                      child: Image.asset(
                        'assets/ui-mobile/images/outline-interface-arrow-right-cVp.png',
                        width: 13*fem,
                        height: 13.18*fem,
                      ),
                    ),
